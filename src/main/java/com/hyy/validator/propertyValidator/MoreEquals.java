 ...
 *
 */
public class MoreEquals extends Rule{

	private Object other;
	public MoreEquals(String propertyName, ValidType type, String errorMessage) {
		super(propertyName, type, errorMessage);
	}
	
	public MoreEquals(String propertyName, ValidType type, Object other , String errorMessage) {
		super(propertyName, type, errorMessage);
		this.other = other;
	}
