 ...
 *
 */
public class More extends Rule{

	private Object other;
	public More(String propertyName, ValidType type, String errorMessage) {
		super(propertyName, type, errorMessage);
	}
	
	public More(String propertyName, ValidType type, Object other , String errorMessage) {
		super(propertyName, type, errorMessage);
		this.other = other;
	}
