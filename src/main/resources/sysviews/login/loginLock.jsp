...
//						alert(result.message);
            ...
            <form role="form" id="lockscreen" name="loginForm" action="/login/login.cc" class="lockcreen-form fade-in-effect">

                <input type="hidden" name="JobNumber" value="${jobNumber}">
                <div class="user-thumb">
                    <a href="#">

                        <img src="<c:if test="${not empty image}">${image}</c:if>/assets/images/user-5.png"  class="img-responsive img-circle" />
                    </a>
                </div>
